"""Canonical Sonic USB service layer for CLI, HTTP, and MCP surfaces."""
...
from core.os_limits import detect_platform, is_supported, os_capabilities, support_message
from installers.usb.manifest import default_manifest, read_manifest, validate_manifest_data
